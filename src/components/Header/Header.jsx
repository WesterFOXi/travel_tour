...
const Header = ({ setIsOpenSing, setIsOpenLogin }) => {
   ...
   console.log(isPageChoose);
   return (
      <header className={[cl.header].join(" ")}>
         <CustomLink isPageChoose={isPageChoose} to={"/"}>
         ...
         <nav className={cl.nav_button}>
            ...
            <CustomLink isPageChoose={isPageChoose} to={"/AboutUs"}>
               <Button>About Us</Button>
            </CustomLink>
            <CustomLink isPageChoose={isPageChoose} to={"/TourPackages"}>
               <Button>Tour Packages</Button>
            </CustomLink>
            <CustomLink isPageChoose={isPageChoose} to={"/ContactUs"}>
         ...
         <div className={cl.btn_reg}>
            <Button
               ...
               className={[
                  cl.header_button_account,
                  !isPageChoose ? cl.btn_active_login : "",
               ].join(" ")}
            >
               Login
            </Button>
